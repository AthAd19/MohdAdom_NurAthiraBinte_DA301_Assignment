...
qplot(NA_Sales, Global_Sales, data=sales_useful, colour=Platform)
  # 1 outlier point with significantly higher sales numbers

  # 3 products sell well in NA but not in EU
...
## Your observations and insights here ......
  ...
  # 1) NA Sales > EU Sales
  # 2) Relative sales for most products are similar across the regions
  ...
  # 3) Upper whisker is larger than IQR
  #   - upper 25% of products sell significantly more than the other products

  # 4) 1 product has outstanding sales : Product 107 on Wii 
